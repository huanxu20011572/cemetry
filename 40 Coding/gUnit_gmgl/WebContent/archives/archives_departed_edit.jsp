...
function doSave(){
	...
	var rentrelation=$.trim($("#rentrelation").val());
	if(rentrelation=="-1"){
		alert("请录入与承租人关系");
	    return false;
	}
	...
	var factBuryDate=$.trim($("#factBuryDate").val());
	if(factBuryDate == "" ){
		alert("请填写实际安放日期");
		return;
	}
  ...
  <tr>
    ...
    <td align="center" valign="top" >
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td height="31" align="left" valign="middle" style="background:url(../images/right-3.jpg)"><img src="../images/right-4.jpg" width="9" height="8" align="absmiddle" /> 当前位置 &gt; 档案管理 &gt; 逝者信息登记</td>
	      </tr>
	      <tr>
	        <td bgcolor="#FFFFFF" style="font-size:12px;">&nbsp;</td>
	      </tr>
	    </table>
	  <form id='saveDepartForm' action="archivesDepartedController.fj?method=saveDeparted" method='post'>     
			      ...
			      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
					...
					<tr>
					  ...
					  <td bgcolor='#ffffff' align='left'><input id='age' class='input-1' name='age'  value="${entity.age}" />
					  <span class="word-7">*</span></td>
					  <td width="15%" height="35" align="right" bgcolor="#D4E5F4"><!-- 证件编号： --></td>
			          <td width="35%" align="left" bgcolor="#FFFFFF"><%-- <input name="cardNum" type="text" id="cardNum" class="input-1"  value="${entity.cardNum}"/>
			          <span class="word-7">*</span> --%></td>
			        ...
			        <tr>
			          ...
			          <td align="left" bgcolor="#FFFFFF"><ft:select name="cardType" type="zjlx" selected="${entity.cardType}"  style="width:190px"></ft:select>
			            <span class="word-7">*</span></td>
			          <td width="15%" height="35" align="right" bgcolor="#D4E5F4">证件号码：</td>
			          <td width="35%" align="left" bgcolor="#FFFFFF" colspan='3'>
			            ...
			            <span class="word-7">* (无证件号码请填0)</span>		    
					  </td>
			        </tr>
					<tr>
					...
					<tr>
			          ...
			          <td bgColor='#ffffff' align='left'> 
			             <input id='birthDate' class='input-1' name='birthDate' onClick="WdatePicker()"  value="<fmt:formatDate value='${entity.birthDate}' pattern="yyyy-MM-dd"/>" />
			             <span class="word-7">*</span></td>
			    </tr>
			    <tr>
			      ...
			      <td bgColor='#ffffff' align='left'> 
			        <input id='factBuryDate' class='input-1' name='factBuryDate' onClick="WdatePicker()"  value="<fmt:formatDate value='${entity.factBuryDate}' pattern="yyyy-MM-dd"/>" />
			        <span class="word-7">*</span></td>
			    </tr>
			        <tr>
