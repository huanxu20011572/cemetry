...
public  class DBWhBaseDAO  {

	protected DBWrapper dbWrapper;

	private final static String DEFAULT_SCHEMA = "wh";

	public DBWhBaseDAO() {
		this(DEFAULT_SCHEMA);
	}

	public DBWhBaseDAO(String schema) {
	 ...
	 * @return List
	 */
	public List queryList(Serializable sql, Object[] objs, Type[] types) throws TSDBException {
		String strSQL = "";
