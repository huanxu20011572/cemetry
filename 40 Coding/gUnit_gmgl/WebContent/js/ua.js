/*
 * $Log: ua.js,v $
 * Revision 1.2  2009/07/29 02:23:08  wangrui
 * *** empty log message ***
 *
 * Revision 1.1  2009/06/27 10:03:07  rongyinghui
 * *** empty log message ***
 *
 * Revision 1.1  2009/05/06 06:38:16  rongyinghui
 * *** empty log message ***
 *
 * Revision 1.1  2009/02/20 01:12:40  liushuhua
 * *** empty log message ***
 *
 * Revision 1.3  2004/05/09 03:43:07  zhx
 * mzj copy
 *
...
function generateRadioC(parentfolderObject, itemLabel, itemId) {
	var newObj;
	...
	// use the prependHTML. There are general instructions about this member
    // in the online documentation
	newObj.prependHTML = "<td valign=middle><input type=radio name=hourPick id="+itemId+"></td>"
}