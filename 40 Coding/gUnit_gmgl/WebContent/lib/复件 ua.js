 ...
 * *** empty log message ***
 *
 * Revision 1.2  2007/12/26 10:15:08  lxr
 * *** empty log message ***
 *
 ...
 * *** empty log message ***
 *
 * Revision 1.1.1.1  2003/09/22 11:10:43  zhx
 * no message
 *
...
function generateCheckBox1(parentfolderObject, itemLabel, checkBoxDOMId, linkLabel) {
	...
	// Read the online documentation for an explanation of insDoc and gLnk,
    // they are the base of the simplest Treeview trees
        itemLabel = itemLabel + "<td class='unnamed1'><div align='center'><a href='officeUpdate.do?action=showUpdate&id=" + checkBoxDOMId + "'><img src='../images/config/zoom_small.gif' width='13' height='13' border='0' onMouseOver=\"this._tip = '<center><font color=#FF0000>修改此部门信息</font></center>' \"></a>&nbsp;"  
        itemLabel = itemLabel + "<td class='unnamed1'><div align='center'><a href='officeAdd.do?action=createChild&id=" + checkBoxDOMId + "'><img src='../images/config/create.gif' width='13' height='13' border='0' onMouseOver=\"this._tip = '<center><font color=#FF0000>创建此部门的子部门</font></center>' \"></a>&nbsp;"  
        itemLabel = itemLabel + "<td class='unnamed1'><div align='center'><a href='officeMove.do?action=moveTo&id=" + checkBoxDOMId + "'><img src='../images/config/move.gif' width='13' height='13' border='0' onMouseOver=\"this._tip = '<center><font color=#FF0000>将此部门移动到其它位置</font></center>' \"></a>&nbsp;"  
        itemLabel = itemLabel + "<td class='unnamed1'><div align='center'><a href='officeDelete.do?action=deleteConfirm&id=" + checkBoxDOMId + "'><img src='../images/config/delete.gif' width='13' height='13' border='0' onMouseOver=\"this._tip = '<center><font color=#FF0000>删除此部门</font></center>' \"></a></div></td>"  
