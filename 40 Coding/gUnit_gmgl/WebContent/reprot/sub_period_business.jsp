...
function doSubmit(){
	var ifm= document.getElementById("iframepage");
	var action = "../reportJsp/showReport.jsp?raq=/sub_period_business.raq";
		action += "&org_id=<c:out value="${user.deptid}" />";
		action += "&org_name=<c:out value="${user.deptname}" />";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="31" align="left" valign="middle" style="background:url(../images/right-3.jpg)"><img src="../images/right-4.jpg" width="9" height="8" align="absmiddle" /> 当前位置  &gt; 综合统计 &gt; 同期业务对比表</td>
      </tr>
      <tr>
	...
	<table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
	  ...
	  <iframe onLoad="autoIframe();" id="iframepage" name="iframepage" frameBorder=0 scrolling=no width="98%" 
      		src="../reportJsp/showReport.jsp?raq=/sub_period_business.raq&org_id=<c:out value="${user.deptid}" />&org_name=<c:out value="${user.deptname}" />" ></iframe>
</body>
</html>