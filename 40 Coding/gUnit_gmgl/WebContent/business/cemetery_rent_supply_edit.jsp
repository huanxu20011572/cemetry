...
<script type="text/javascript">
   ...
   function getCemeteryFileEdit(regeditId){
		...
		var redirect_url =$.base64.encode('cemeteryRegistryController.fj?method=editCemeteryRegistrySupply&cemeteryRegistryType=1&id='+regeditId);
		location.href = "cemeteryRegistryController.fj?method=getCemeteryFileEdit&cemeteryRegistryType=1&isSupply=1&id="+regeditId +"&redirect_url="+redirect_url;
   }
   //选择墓位后回调使用获取墓型信息
        ...
        <td bgcolor="#C4DEEE"><table id="baseInfo" width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
            ...
            <tr>
              ...
              <td align="left" bgcolor="#FFFFFF"><ft:select	name="cardType" type="zjlx" selected="${entity.cardType}"	style="width:190px"></ft:select>
                <span class="word-7">*</span></td>
              <td height="35" align="right" bgcolor="#D4E5F4">证件编码：</td>
        ...
        <td height="102" bgcolor="#C4DEEE"><table width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
            ...
            <c:forEach var="cemeteryCharge" items="${entity.cemeteryCharges}" varStatus="status">
              <tr>
                ...
                <td align="center" bgcolor="#FFFFFF" class="word-7"	width="20%"><a href="cemeteryRegistryController.fj?method=deleteCemeteryCharge&isSupply=1&cemeteryRegistryType=${entity.cemeteryRegistryType}&id=${cemeteryCharge.id}&cemeteryRegistryId=${entity.id}">删除</a></td>
              </tr>
            </c:forEach>
          </table></td>
      </tr>
