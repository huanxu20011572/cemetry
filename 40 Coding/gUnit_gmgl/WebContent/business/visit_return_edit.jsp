  ...
  <tr>
    ...
    <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
        ...
        <tr>
          ...
          <input name="customerName" type="text" id="customerName" class="input-1"  value="<c:out value='${visitReturn.customerName}'/>"/>
          <span class="word-7">*</span>
          </td>
          <td width="15%" align="right" bgcolor="#D4E5F4">联系电话：</td>
          <td width="35%" align="left" bgcolor="#FFFFFF">
          <input name="customerTel" type="text" id="customerTel" class="input-1"  value="<c:out value='${visitReturn.customerTel}'/>"/>
          <span class="word-7">*</span>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td  colspan='3' align="left" bgcolor="#FFFFFF">
            <textarea id="customerReq" name="customerReq" class="input-1" style='height:60px;width:90%'><c:out value='${visitReturn.customerReq}'/></textarea>
            <span class="word-7">*</span>
            </td>
        </tr>
        <tr>
	...
	<script type="text/javascript">
		function doSave(){
			...
			if(customerReq.length>1000){
				alert("来访需求的最大长度为1000个字符！");
				return;
			}
			...
			if(customerNum!=''&&!/^[0-9]+$/g.test(customerNum)){
				alert("来访人数必须为数字！");
				return;
			}
			var customerSource=$.trim($("#customerSource").val());
			if(customerSource.length>200){
				alert("客户来源的最大长度为200个字符！");
				return;
			}
			var remark=$.trim($("#remark").val());
			if(remark.length>200){
				alert("备注的最大长度为1000个字符！");
				return;
			}
			if(confirm("确定要保存？")){
