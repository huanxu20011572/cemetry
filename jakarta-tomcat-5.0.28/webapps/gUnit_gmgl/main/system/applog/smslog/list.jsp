          ...
          <td width="31%" align="right">
		    <table border="0" cellpadding="0" cellspacing="0">
              <tr class="td16"> 
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td width="52">【<a href="smslog.do?action=search">查询</a>】</td>
              </tr>
            </table>
		  </td>
        </tr>
      ...
      <table width="100%" border="1">
	      <tr>
			<form name="tform" action="smslog.do?action=list" method="post">
	             ...
	             【<a href="javascript:tform.submit();">确定</a>】
	             【<a href="javascript:tform.action='smslog.do?action=export';tform.submit();">导出</a>】
	             </td>
	             </form>
	     </tr>
      </table>
