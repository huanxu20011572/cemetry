...
<body style="background-color: transparent">
	<form action="cemeteryZoneController.fj?method=saveCemeteryZone" id="isform"
		...
		<input type="hidden" value="<c:out value='${param.pid}'/>"
			name="pid" id="pid" /> <input type="hidden"
			value="<c:out value='${param.id}'/>" name="id" id="id" />
		...
		<table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
			<tr>
				...
				<td width="34%" align="left" bgcolor="#FFFFFF"><input name="cemeteryZoneName"
					...
					value="<c:out value='${zone.cemeteryZoneName}'/>" /></td>
				...
				<td width="33%" align="left" bgcolor="#FFFFFF">
					...
					<select name="isValidate" class="input-1" style='height: 22px'>
						<option value='1'
							<c:if test="${zone.isValidate == '1'}">selected</c:if>>是</option>
						<option value='0'
							<c:if test="${zone.isValidate == '0'}">selected</c:if>>否</option>
				</select></td>
			</tr>
			<tr>
				...
				<td align="left" bgcolor="#FFFFFF"><input name="sort"
					...
					value="<c:out value='${zone.sort}'/>" /></td>
			...
			<tr>
				...
				<td colspan="3" align="left" bgcolor="#FFFFFF"><textarea
						...
						class="input-1"><c:out value='${zone.remark}' /></textarea></td>
			</tr>
			<tr>
