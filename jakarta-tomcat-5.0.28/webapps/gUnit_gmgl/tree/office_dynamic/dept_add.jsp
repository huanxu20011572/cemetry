...
function doCancel(){
	window.location = "office_list.jsp?idStr=" + '<c:out value="${param.deptId}" />';
}
function onSubmit() {
 	 var IsValid=true; 	
...
<body>
	<form action="doAddDept.do?method=add" name="myform" method="post">
  ...
  <tr>
	...
	<table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da" class="word-8">
	  <tr>
	    ...
	    <td width="35%" align="left" bgcolor="#FFFFFF"><c:out value='${region.name}' />
	          			<input type="hidden" name="regionId" value="<c:out value='${region.id}' />"><label id="regionIdlbl" name="regionIdlbl"></label></td>
	    <td width="15%" align="right" bgcolor="#D4E5F4">上级机构：</td>
	    <td align="left" bgcolor="#FFFFFF" ><input name="parentName" type="text" value='<c:out value="${parentDept.name}" />' readonly /><span class="text-red">*</span> <a href="javascript:selectOffice()" ><img src="../images/config/zoom_small.gif" width="13" height="13" border="0"></a> 
              <input type="hidden" name="parentId" value="<c:out value='${parentDept.id}' />"><label id="parentIdlbl" name="parentIdlbl"></label></td>
	    </tr>
	  <tr>
	    <td height="35" align="right" bgcolor="#D4E5F4">行政级别：</td>
	    <td  width="35%" align="left" bgcolor="#FFFFFF"> <select name="levelId">
		        		<option selected>请选择行政级别...</option>
		        		<option value="1" >市级</option>
		        		<option value="2" >区县</option>
		        		<option value="3" >街道</option>
		        		<option value="4" >社区</option>
		        	</select><span class="text-red">*</span> <label id="levelIdlbl" name="levelIdlbl"></label></td>
	    <td align="right" bgcolor="#D4E5F4">机构名称：</td>
	    <td align="left" bgcolor="#FFFFFF"><input name="name" type="text" size="20" width="150" height="18" maxlength="30"><span class="text-red">*</span>
	  ...
	  <tr>
	    ...
	    <td  width="35%" align="left" bgcolor="#FFFFFF"><select name="treeNode">
		        	...
		        	</select><span class="text-red">*</span> <label id="treeNodelbl" name="treeNodelbl"></label></td>
	    <td align="right" bgcolor="#D4E5F4">机构编码：</td>
	    <td align="left" bgcolor="#FFFFFF"><input name="jgmx" type="text" size="20" width="150" height="18" maxlength="30" value="<c:out value='${dept.jgmx}' />"><span class="text-red">*</span> <label id="jgmxlbl" name="jgmxlbl"></label></td>
	    </tr>
	  </table>
