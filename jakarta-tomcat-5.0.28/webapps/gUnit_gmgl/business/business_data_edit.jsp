    ...
    <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
        ...
        <tr>
          ...
          <input name="businessName" type="text" id="businessName" class="input-1"  value="<c:out value='${businessData.businessName}'/>"/></td>
          <td width="15%" align="right" bgcolor="#D4E5F4">大分类：</td>
          <td width="35%" align="left" bgcolor="#FFFFFF"><ft:select name="businessType" type="ywdl" selected="${businessData.businessType}" style="width:190px"></ft:select></td>
        </tr>
        <tr>
