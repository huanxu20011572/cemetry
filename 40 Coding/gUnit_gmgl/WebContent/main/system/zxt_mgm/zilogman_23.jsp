...
<form action="UserextCreate.do?action=step23" name="myform" method="post">
  ...
  <table width="90%" border="0" align="right" cellpadding="0" cellspacing="0" class="table10">
    ...
    <td valign="top" class="td18">
      ...
      <TABLE border=5 width="300" align="center" borderColor=EECCB4 borderlight="green">
        <TBODY>
          <TR>
            <TD align="center">
