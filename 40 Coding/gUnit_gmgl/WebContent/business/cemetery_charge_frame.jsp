...
function saveOutStorehouse() {
	...
	cemeteryChargeForm.action = "cemeteryRegistryController.fj?method=saveCemeteryChargeList";
...
function bulidCommodityPrice(i_input,id,num,price){
	 ...
	 //补录数据不验证库存数量
	 <c:if test="${param.isSupply != 1}">
	 if (parseFloat(i_input.value) > parseFloat(num)) {
	        alert("收入数量不能大于库存数量");
	        return false;
	 }
	 </c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="31" align="left" valign="middle" style="background:url(../images/right-3.jpg)"><img src="../images/right-4.jpg" width="9" height="8" align="absmiddle" /> 当前位置 &gt;业务办理  &gt; 收费信息登记</td>
      </tr>
      <tr>
      ...
      <table id="cemeteryChargeTable" width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
       ...
       <table>
         <tr>
           ...
           <input name="button" type="button" onclick="saveOutStorehouse();" class="button-z" id="button" value="完成" /> &nbsp;&nbsp; 
