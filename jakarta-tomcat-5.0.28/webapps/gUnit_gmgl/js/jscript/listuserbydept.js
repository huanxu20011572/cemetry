...
var users = root.childNodes;
 ...
 for(var i=0;i<users.length;i++){
    ...
    userDiv.innerHTML="<img src='"+image_line+"' align='absbottom' ><img src='"+image_join+"' onclick='listUser("+users[i].getAttribute("id")+")' align='absbottom'><img src='"+image_page+"' align='absbottom'><input type='checkbox' name='userId' border='0' style='height:18' value='"+users[i].getAttribute("userId")+"|"+users[i].getAttribute("name")+"|"+users[i].getAttribute("positionId")+"'>"+users[i].getAttribute("name");
...
userDivs.innerHTML="";
 for(var i=0;i<users.length;i++){
    var userDiv = document.createElement("DIV");
    userDiv.innerHTML="<img src='"+image_line+"' align='absbottom' ><img src='"+image_join+"' onclick='listUser("+users[i].getAttribute("id")+")' align='absbottom'><img src='"+image_page+"' align='absbottom'><input type='checkbox' name='userId' border='0' style='height:18' value='"+users[i].getAttribute("userId")+"|"+users[i].getAttribute("name")+"'>"+users[i].getAttribute("name");
    userDivs.appendChild(userDiv);
 };
...
window.opener.document.getElementById("receiveNo").value="0";
window.close();
//alert(user_ids);
//alert(user_desc);
}
