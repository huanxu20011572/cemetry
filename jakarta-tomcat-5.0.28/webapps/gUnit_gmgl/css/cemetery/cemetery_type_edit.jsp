    ...
    <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
        <tr>
          ...
          <td width="35%" align="left" bgcolor="#FFFFFF">
            <input name="cemeteryTypeCode" type="text" class="input-1" id="cemeteryTypeCode" value="<c:out value='${cemeteryType.cemeteryTypeCode}'/>" /></td>
        ...
        <tr>
				<td height="35" align="right" bgcolor="#D4E5F4">墓型名称：</td>
					...
					<tr>
		              ...
		              <td align="left" bgcolor="#FFFFFF">
	                  <input name="specification" type="text" class="input-1" id="specification" value="<c:out value='${cemeteryType.specification}'/>" /></td>
		              <td align="right" bgcolor="#D4E5F4">面积：</td>
		              <td align="left" bgcolor="#FFFFFF">
		                <input name="area" type="text" class="input-1" id="area" value="<c:out value='${cemeteryType.area}'/>" /></td>
	                </tr>
		            <tr>
		              ...
		              <td align="left" bgcolor="#FFFFFF">
	                  <input name="boxsize" type="text" class="input-1" id="boxsize" value="<c:out value='${cemeteryType.boxsize}'/>" /></td>
	                </tr>
		            <tr>
		              <td height="35" align="right" bgcolor="#D4E5F4">墓型总价格：</td>
		              <td align="left" bgcolor="#FFFFFF">
		                <input name="totalPrice" type="text" class="input-1" id="totalPrice" value="<c:out value='${cemeteryType.totalPrice}'/>" /></td>
      ...
      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
        <tr>
          ...
          <td width="35%" align="left" bgcolor="#FFFFFF">
            <input name="groundPrice" type="text" class="input-1" id="groundPrice" value="<c:out value='${cemeteryType.groundPrice}'/>" /></td>
          <td width="15%" align="right" bgcolor="#D4E5F4">管理费：</td>
          <td width="35%" align="left" bgcolor="#FFFFFF">
            <input name="managePrice" type="text" class="input-1" id="managePrice" value="<c:out value='${cemeteryType.managePrice}'/>" /></td>
        </tr>
        <tr>
          <td height="35" align="right" bgcolor="#D4E5F4">工程费：</td>
          <td align="left" bgcolor="#FFFFFF"  colspan='3' >
            <input name="constructionPrice" type="text" class="input-1" id="constructionPrice" value="<c:out value='${cemeteryType.constructionPrice}'/>" /></td>
        </tr>
