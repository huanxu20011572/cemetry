        ...
        <tr bgcolor="#FFFFFF">
               <td height="35"  colspan="4" align="center"  bgcolor="#FFFFFF" >			    
			      <input name="button" type="submit" class="button-z" id="button" value="查询" /> 
				   &nbsp;&nbsp;
				  <input name="button2" type="reset" class="button-z" id="button2" onClick="doReset()" value="重置" />
			   </td>                                              
        </tr>
      </table>
      </form>
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="10" class="word-4">
		<tr align="right" >
			...
			<ft:page action="cemeteryTypeController.fj?method=getCemeteryTypeList" page="${page}">
				...
				<input name="cemeteryTypeName" type="hidden" id="cemeteryTypeName" class="input-1" value="<c:out value='${param.cemeteryTypeName}'/>"/>
				<input name="cemeteryProperty" type="hidden" id="cemeteryProperty" class="input-1" value="<c:out value='${param.cemeteryProperty}'/>"/>
				<input name="cave" type="hidden" id="cave" class="input-1" value="<c:out value='${param.cave}'/>"/>
			</ft:page> 
			</td >
