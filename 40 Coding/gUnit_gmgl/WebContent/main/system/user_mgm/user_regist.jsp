...
function onSubmit() {	 
	 ...
	 if(!checkEnglish(myform.emailid.value))
	 {
	 	document.all("emaillbl").innerHTML="<font color=\"ff0000\">邮箱id不正确</font>";
	 	IsValid=false;
	 }
	 else
	 document.all("emaillbl").innerHTML="";
...
<form action="registAdd.do?action=regist" name="myform" method="post">
    ...
    <td align="right" valign="top" class="td18"> 
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table7">
        <tr> 
          ...
          <td width="54%" height="20" align="left"> <strong>新用户注册(*为必填项)<font color="ff0000"><html:errors/></font></strong></td>
      ...
      <table width="100%" border="0" cellpadding="1" cellspacing="1" class="table_main">
        ...
        <tr> 
          ...
          <td width="38%" class="td23"> <input name="cansms" type="checkbox"></td>
        </tr>
        <tr height="22" > 
        ...
        <tr> 
          ...
          <a href="javascript:windowWithoutToolbar('../office_mgm/regist_office_choose.jsp?inputBox=dept', 400, 600)"><img src="../../../images/config/zoom_small.gif" width="13" height="13" border="0"></a> 
        ...
        <tr> 
          ...
          <td height="22" class="td23"> <input name="publicmoneynum" type="text" value="<c:out value="${user.publicmoneynum}"/>" size="20" width="150" height="18" maxlength="30"></td>
          <td class="td22">养老保险号：</td>
          <td class="td23"> <input name="oldsupportnum" type="text" value="<c:out value="${user.oldsupportnum}"/>" size="20" width="150" height="18" maxlength="30"></td>
        </tr>
        <tr> 
          <td height="22" class="td22">住房补贴号：</td>
          <td height="22" class="td23"> <input name="housepaynum" type="text" value="<c:out value="${user.housepaynum}"/>" size="20" width="150" height="18" maxlength="30"></td>
          <td class="td22">医疗保险号：</td>
          <td class="td23"> <input name="securitynum" type="text" value="<c:out value="${user.securitynum}"/>" size="20" width="150" height="18" maxlength="30"></td>
        </tr>
        <tr> 
          ...
          <a href="javascript:windowWithoutToolbar('../office_mgm/regist_office_choose.jsp?inputBox=workdept', 400, 600)"><img src="../../../images/config/zoom_small.gif" width="13" height="13" border="0"></a> 
            <font color="#0000ff">单击前面的图标选择部门</font>
          </td> 
        </tr>
        <tr> 
