 ...
 * *** empty log message ***
 *
 * Revision 1.3  2007/10/26 09:06:57  lxr
 * *** empty log message ***
 *
 ...
 * *** empty log message ***
 *
 * Revision 1.1  2004/09/09 10:38:15  zhx
 * no message
 *
...
function generateCheckBox1(parentfolderObject, itemLabel, checkBoxDOMId, linkLabel) {
    ...
    // they are the base of the simplest Treeview trees
        ...
        itemLabel = itemLabel + "<a href='regionUpdate.do?action=showUpdate&id=" + checkBoxDOMId + "'>编辑</a>&nbsp;&nbsp;&nbsp;"  
        itemLabel = itemLabel + "<a href='regionMove.do?action=moveTo&id=" + checkBoxDOMId + "'>移动</a>&nbsp;&nbsp;&nbsp;"  
        itemLabel = itemLabel + "<a href='regionDelete.do?action=deleteConfirm&id=" + checkBoxDOMId + "'>删除</a>&nbsp;&nbsp;&nbsp;"  
        itemLabel = itemLabel + "<a href='regionSelect.do?action=listoffice&id=" + checkBoxDOMId + "'>显示区域部门</a></td>" 
        itemLabel = itemLabel + "</tr></table></td>"; 
	newObj = insDoc(parentfolderObject, gLnk("S", itemLabel, "regionSelect.do?action=detail&id="+linkLabel));
...
function generateCheckBox1(parentfolderObject, itemLabel, checkBoxDOMId, linkLabel, isFld) {
    ...
    // they are the base of the simplest Treeview trees
        ...
        itemLabel = itemLabel + "</tr></table></td>"; 
        if (isFld=="true"){	
					newObj = insFld(parentfolderObject, gFld(itemLabel, "regionSelect.do?action=detail&id="+linkLabel));
				} else {
					newObj = insDoc(parentfolderObject, gLnk("S", itemLabel, "regionSelect.do?action=detail&id="+linkLabel));
				}
...
function generateDoc(parentfolderObject, itemLabel, linkLabel){
    ...
    itemLabel = itemLabel + "<a href='GUnitUpdate.do?action=deketePri&id=" + linkLabel + "'>删除</a>&nbsp;"  
    itemLabel = itemLabel + "</tr></table></td>"; 
    linkLabel = "GUnitShow.do?action=showPri&id=" + linkLabel;
	insDoc(parentfolderObject, gLnk("R", itemLabel, linkLabel))
}

function generateFld(parentfolderObject, itemLabel, linkLabel, menutype){
	itemLabel = itemLabel + "<td width='400'><table><tr>";
	if(menutype=="NULL_gT"){
		itemLabel = itemLabel + "<td class='unnamed1' width='400' align='left'><a href='GUnitUpdate.do?action=showUpdate_gT&id=" + linkLabel + "'>编辑</a>&nbsp;"  
    	itemLabel = itemLabel + "<a href='#'>删除</a>&nbsp;"  
    	itemLabel = itemLabel + "<a href='GUnitUpdate.do?action=showAddMenu_gT&id=" + linkLabel + "'>添加下级菜单</a>&nbsp;"  
        itemLabel = itemLabel + "<a href='GUnitUpdate.do?action=showAddPri_gT&id=" + linkLabel + "'>添加权限</a>&nbsp;"  
        linkLabel = "GUnitShow.do?action=showgT&id=" + linkLabel;
	}
	else if(menutype=="NULL_gC"){
		itemLabel = itemLabel + "<td class='unnamed1' width='400' align='left'><a href='GUnitUpdate.do?action=showUpdate_gC&id=" + linkLabel + "'>编辑</a>&nbsp;"  
    	itemLabel = itemLabel + "<a href='#'>删除</a>&nbsp;"  
    	itemLabel = itemLabel + "<a href='GUnitUpdate.do?action=showAddMenu_gC&id=" + linkLabel + "'>添加下级菜单</a>&nbsp;"  
        itemLabel = itemLabel + "<a href='GUnitUpdate.do?action=showAddPri_gC&id=" + linkLabel + "'>添加权限</a>&nbsp;"  
        linkLabel = "GUnitShow.do?action=showgC&id=" + linkLabel;
	}
	else if(menutype=="gE" || menutype=="NULL_gE"){
		itemLabel = itemLabel + "<td class='unnamed1' width='400' align='left'><a href='GUnitUpdate.do?action=showUpdate_gE&id=" + linkLabel + "'>编辑</a>&nbsp;"  
    	itemLabel = itemLabel + "<a href='#'>删除</a>&nbsp;"  
        itemLabel = itemLabel + "<a href='GUnitUpdate.do?action=showAddPri_gE&id=" + linkLabel + "'>添加权限</a>&nbsp;"  
        linkLabel = "GUnitShow.do?action=showgE&id=" + linkLabel;
	}
	else if(menutype=="gT"){
		itemLabel = itemLabel + "<td class='unnamed1' width='400' align='left'><a href='GUnitUpdate.do?action=showUpdate_gT&id=" + linkLabel + "'>编辑</a>&nbsp;"  
    	itemLabel = itemLabel + "<a href='#'>删除</a>&nbsp;"  
