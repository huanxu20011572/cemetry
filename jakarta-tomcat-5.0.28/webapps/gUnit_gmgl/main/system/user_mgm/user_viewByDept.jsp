        ...
        <tr>
         <form name="sform" action=userSelect.do?action=find method="post">            
          <td width="55%" valign="bottom">            	            
	        ...
	        <input name="search2" type="button" class="button1" id="search" value="高级搜索" onClick="parent.mainFrame.location.href='bmry_user_search.jsp?deptid=<%=addDeptId%>&deptName=<c:out value="${deptName}"/>'; return true;">	              	    
