	...
	**/
	function doOpenMid(formName){			
		toMid(formName, null, null);		
	}
	
	function toMidSchm(formName, flag, toStrUrl, frameName){	
		  var strForm = document[formName];
    	var strUrl = "/shjzmid/tologin.jsp?1=1";
    	
    	if(flag != null)
    		strUrl += "&flag=" + flag;	
	    if(toStrUrl != null)
	      strUrl += "&toStrUrl=" + toStrUrl;	
	   	  	      				
			strForm.action = strUrl;
			if(frameName != null)
			   strForm.target = frameName;
			strForm.method = "post";   
	...
	/**	登录到中间库		
	**/
	function toMid(formName, flag, toStrUrl){	
		toMidSchm(formName, flag, toStrUrl, "import_frame");
 	...
 	*/
 	function showImages(imgBN, objBN ,ctImage, ctObj){
			...
			if(imgBN != null){
			         ...
			         allImgs.src="/shjz/main/images/n-up.gif";	      
		 				} 				
		 			}				
			}
	    ...
	    if(ctObj.style.display == "none"){ 
	        ...
	        ctImage.src="/shjz/main/images/n-down.gif";	        
			
	    }else{
	        ctObj.style.display = "none";
	        ctImage.src="/shjz/main/images/n-up.gif";
	    }	
