...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    ...
    <td align="center" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="31" align="left" valign="middle" style="background:url(../images/right-3.jpg)"><img src="../images/right-4.jpg" width="9" height="8" align="absmiddle" /> 选择墓位信息</td>
      </tr>
      <tr>
	 ...
	 <div class="easyui-layout" style="width:100%;height:450px;">
	    ...
	    <div id="mainPanle" region="center"  style="padding:10px 0 10px 10px;">
			<iframe frameborder="0"  width="100%" src="cemeteryLocationController.fj?method=getCemeteryLocationSelectListByPID" height="100%" scrolling="auto" id="treelist" name="treelist" allowtransparency="true"  ></iframe>
	    </div>
	  ...
	  $('#lefttree').tree({
			...
			onClick: function(node){
				if(node.state == undefined){
					var value = "cemeteryLocationController.fj?method=getCemeteryLocationSelectListByPID";
					//是否弹出页面
