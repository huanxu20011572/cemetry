  ...
  <tr>
	...
	<table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da" class="word-8">
	  ...
	  <tr>
	    ...
	    <td  width="35%" align="left" bgcolor="#FFFFFF"><input name="regionCode" type="text" size="20" width="150" height="18" maxlength="15"><span class="word-7">*</span><br> <label id="regionCodelbl" name="regionCodelbl"></label></td>
