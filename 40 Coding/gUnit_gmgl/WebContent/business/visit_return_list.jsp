      ...
      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
        ...
        <tr>
          ...
          <input name="button" type="submit" class="button-z" id="button" value="查询" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input name="button2" type="reset" class="button-z" id="button2" value="重置" onclick="resetForm()"/>
          </td>
        </tr>
      </table>
	 </form>
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="10" class="word-4">
		<tr align="right" >
			...
			<ft:page action="visitReturnController.fj?method=getVisitReturnList" page="${page}">
          		<input name="customerName" type="hidden" id="customerName" class="input-1" value="<c:out value='${param.customerName}'/>"/>
          		<input name="beginCreateDate" type="hidden" class="Wdate" id="beginCreateDate" onfocus="WdatePicker()" value="<c:out value='${param.beginCreateDate}'/>" />
          		<input name="endCreateDate" type="hidden" class="Wdate" id="endCreateDate" onfocus="WdatePicker()" value="<c:out value='${param.endCreateDate}'/>" />
			</ft:page> 
			</td >
