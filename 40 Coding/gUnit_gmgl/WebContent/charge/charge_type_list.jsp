			...
			<!-- 	 <form  action ="chargeTypeController.fj?method=deleteChargeType" id="isdelform" method="post"> </form> -->
				 <table width="98%" border="0" cellspacing="0" cellpadding="10" class="word-4">
					<tr align="right" >
						...
						<ft:page action="chargeTypeController.fj?method=getChargeTypeList" page="${page}">
							<input
							name="chargeTypeName" type="hidden" id="chargeTypeName"
							class="input-1"  value="<c:out value='${chargetype.chargeTypeName}'/>"/>
							<input
							name="chargeTypeDict" type="hidden" id="chargeTypeDict"
							class="input-1"  value="<c:out value='${chargetype.chargeTypeDict}'/>"/>
						</ft:page> 
						</td >
