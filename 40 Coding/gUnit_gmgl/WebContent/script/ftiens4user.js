...
{ 
  var leftSide = leftSideHTML(this.leftSideCoded)
  var docW = ""
  var fullLink = "href=\"#\" target=\""+this.target+"\" onClick=\"setRight('"+this.desc+"','"+this.propertyId+"');return false;\"";
...
function setRight(desc,propertyId){
    opener.document.getElementById("quanxian").value = desc;
    opener.document.getElementById("quanxianid").value = propertyId;
    window.close();
}
