...
function changeSelectsEmail(selectObj){
...
function getSelectedEmailGroup(obj){
	var strForm = document.treeForm;
...
<input type="hidden" name="objSelectEmailGroupStrName" value="" >	
  ...
  <div dojoType="TreeNode" title="选择用户<a href='javascript:getSelect()'>[确认添加]</a><a href='javascript:clearSelect()'>[取消添加]</a>" widgetId="root" objectId="2,101,<c:out value='${param.treeType}' />" userId="<%=userId%>" isFolder="true" childIconSrc="images/comm.gif" expandLevel="1"/>
	...
	@param :[long]treeType 	  //101，FROM"数字字典"(递归)，显示下级字典
	                            102，FROM"数字字典"(不递归)，显示下级字典
														  ...
														  211，FROM"组织机构ID"，用于“公文收发”：本级和下级；
															...
															602, FROM"区域数据"，依次显示机构、用户，用于“邮件收发”；
