    ...
    <tr>
        ...
        <td align="center" valign="top">
            ...
            <div class="easyui-layout" style="width:100%;height:450px;">
                <div data-options="region:'west',title:'费用分类',split:true" style="width:200px;">
                    <ul id="lefttree"></ul>
                </div>
                <div id="mainPanle" region="center" style="padding:10px 0 10px 10px;">
                    <iframe frameborder="0" width="100%"
                            src="chargeTypeController.fj?method=getChargeTypeListByPID&pid=1" height="100%"
...
<script type="text/javascript">
    $(function () {
        $('#lefttree').tree({
            url: 'chargeTypeController.fj?method=getChargeTypeTreeByPID',
            animate: true,
            onClick: function (node) {
                var value = "chargeTypeController.fj?method=getChargeTypeListByPID&amp;pid=";
