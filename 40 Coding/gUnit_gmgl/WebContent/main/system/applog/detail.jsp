...
<table id="_main_table" width="100%" border="0" cellpadding="0" cellspacing="0" class="table_template">
  ...
  <tr>        
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table7">
         <tr height="20">                    
                    <td width="63%" align="left"><strong>&nbsp;日志详细信息</strong></td>
       ...
       <table width="100%" border="0" class="table5">
          <tr>     
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="1"  class="table_main">
                ...
                <tr height="22">
                    <td class="td22" width="20%">平台名称：</td>
                    <td class="td23" width="30%">
                    	<alog:show type="platform">
			            	<c:out value="${log.platformid}"/>
			            </alog:show>
                    </td>
                    <td class="td22" width="20%">模块名称：</td>
                    <td class="td23"  width="30%"><c:out value="${log.modulename}"/></td>
                </tr>
                <tr height="22">
                    <td class="td22">创建者：</td>
                    <td class="td23"><c:out value="${log.username}"/></td>
                ...
                <tr height="22">
                    ...
                    <td class="td22">产生日期：</td>
                    <td class="td23">
                    	<fmt:formatDate value="${log.apenddate}" pattern="yyyy-MM-dd hh:mm:ss" />
                    </td>
