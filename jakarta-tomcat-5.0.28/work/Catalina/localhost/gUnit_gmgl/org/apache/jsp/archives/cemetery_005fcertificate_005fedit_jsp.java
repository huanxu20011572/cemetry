...
public final class cemetery_005fcertificate_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_fmt_formatDate_0(pageContext))
        return;
      out.write("\n\t\t  </td>         \n        </tr>\n      \n      </table>\n<table>\n                  <td width=\"80\" height=\"35\" align=\"middle\" >\n\t\t\t      \t<input name=\"saveBtn\" type=\"button\" class=\"button-z\" id=\"saveBtn\" value=\"保存\"  onclick=\"doSave();\"/> \n\t\t\t\t  </td>\n\t\t\t\t  <td width=\"80\" height=\"35\"  align=\"middle\" >\n\t\t\t\t\t<form action=\"../frame/xh_bzdj_zsdy.html\"method=\"post\">\t\t \n\t\t\t          <input name=\"button\" type=\"submit\" class=\"button-z\" id=\"button\" value=\"打印\" /> \n\t\t\t\t    </form>\n\t\t\t\t  </td>\n\t\t\t\t<td width=\"80\" height=\"35\"   align=\"middle\" >\t  \n\t\t\t\t   <input class=\"button-z\" name=\"backBtn\" id=\"backBtn\" type=\"button\" onclick=\"doBack();\" value=\"完成\" />\n\t\t\t   </td>\n      </table>\n    </td>\n  </tr>\n</table>\n\t</form>\n\t<script type=\"text/javascript\">\n\t\tfunction doSave(){\n\t\t\tvar charge=$.trim($(\"#charge\").val());\n\t\t\tvar patrn=/^(([1-9]{1}\\d*)|([0]{1}))(\\.(\\d){1,2})?$/;\n\t\t\tif(!patrn.exec(charge)){\n\t\t\t\talert(\"补证费用只能为货币\");\n\t\t\t\treturn;\n\t\t\t}\n\t\t\tvar reason = $.trim($(\"#reason\").val());\n\t\t\tif (\"-1\" == reason) {\n\t\t\t\talert(\"请选择补证原因！\");\n\t\t\t\treturn;\n");
