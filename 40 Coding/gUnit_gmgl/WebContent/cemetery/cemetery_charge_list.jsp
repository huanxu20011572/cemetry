        ...
        <tr bgcolor="#FFFFFF">
               <td height="35"  colspan="4" align="center"  bgcolor="#FFFFFF" >			    
			      <input name="button" type="submit" class="button-z" id="button" value="查询" /> 
				   &nbsp;&nbsp;
				  <input name="button2" type="button" onclick="doReset();" class="button-z" id="button2" value="重置" />
			   </td>                                              
        </tr>
      </table>
      </form>
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="10" class="word-4">
		<tr align="right" >
			...
			<ft:page action="cemeteryChargeController.fj?method=getCemeteryChargeList" page="${page}">
				<input name="productName" type="hidden" class="input-1" id="productName" value="<c:out value='${param.productName}'/>"/>
				<input name="productType" type="hidden" class="input-1" id="productType" value="<c:out value='${param.productType}'/>"/>
			</ft:page> 
			</td >
