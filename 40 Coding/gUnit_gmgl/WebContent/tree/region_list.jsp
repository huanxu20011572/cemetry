...
<input type="hidden" name="nodeLevelid" value="" >		
		 ...
		 <div dojoType="TreeNode"  title="选择区域  
<!-- 		 <a href='javascript:createMergerWindow()'>[区划合并]</a> -->
<!-- 		 <a href='javascript:createDevideWindow()'>[区划拆分]</a> -->
		 " widgetId="root"   objectId="<%=regionId%>,101,600" userId="<%=userId%>" isFolder="true" childIconSrc="images/comm.gif" expandLevel="1"></div>
