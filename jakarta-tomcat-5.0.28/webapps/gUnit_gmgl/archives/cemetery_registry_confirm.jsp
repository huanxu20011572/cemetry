...
<script type="text/javascript">
	function doBack(){
		var redirect_registry_url = $.base64.decode('${param.redirect_registry_url}');
		location.href=redirect_registry_url;
	}
	function doConfrim(){
		location.href="../business/cemeteryRegistryController.fj?method=editCemeteryRegistry&cemeteryRegistryType=${param.action_type}&archivesRegistryId=${entity.id}";
	}
</script>
</head>
...
<!--           租用时显示业务登记和承租人信息 -->
          <c:if test='${entity.cemeteryRegistryType == 1}'>
...
<!--           续租合葬时显示续租信息 -->
          <c:if test='${entity.cemeteryRegistryType == 2 || entity.cemeteryRegistryType == 3}'>
		      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			      <tr>
			        <td width="92%" bgcolor="#EBF4FA"><table width="200" border="0" cellspacing="0" cellpadding="0">
			          <tr>
			            <td width="20" align="right"><img src="../images/tab-01.jpg" width="8" height="27" /></td>
			            <td width="99" align="center" class="tab-img-01"><c:if test='${entity.cemeteryRegistryType == 2}'>续租信息</c:if><c:if test='${entity.cemeteryRegistryType == 3}'>合葬信息</c:if></td>
			            <td width="81" align="left" valign="bottom"><img src="../images/tab-03.jpg" /></td>
		              </tr>
		            </table></td>
	            </tr>
			            ...
			            <table id="baseInfo" width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
			                <tr>
			                    ...
			                    <td width="35%" align="left" bgcolor="#FFFFFF">
			                    	<c:if test='${entity.isOneself == 1}'>是</c:if>
									<c:if test='${entity.isOneself == 0}'>否</c:if>
			                    </td>
			                    <td width="15%" align="right" bgcolor="#D4E5F4">业务编号：</td>
			                    <td width="35%" align="left" bgcolor="#FFFFFF"><c:out value='${entity.cemeteryRegistryCode}'/></td>
			                </tr>
			                <c:if test='${entity.isOneself == 0}'>
<!-- 			                	代理人办理信息 -->
				                    <tr id="no_oneself">
						              <td width="15%"  height="35" align="right" bgcolor="#D4E5F4">代理人姓名： </td>
						              <td width="35%" align="left" bgcolor="#FFFFFF"><c:out value='${entity.agentName}'/></td>
				                      <td width="15%" height="35" align="right" bgcolor="#D4E5F4">代理人电话：</td>
						              <td  width="35%" align="left" bgcolor="#FFFFFF"><c:out value='${entity.agentTel}'/></td>
					                </tr>
				                    <tr  id="no_oneself2"> 
						              <td width="15%"  height="35" align="right" bgcolor="#D4E5F4">代理凭证：</td>
						              <td width="35%" align="left" bgcolor="#FFFFFF"><c:out value='${entity.agentProve}'/></td>
				                    ...
				                    <tr  id="no_oneself3">
						              ...
						              <td height="35" colspan="3" align="left" bgcolor="#FFFFFF"><c:out value='${entity.agentReason}'/></td>
				                    </tr>
			                 </c:if>
			                 <c:if test='${entity.cemeteryRegistryType == 2}'>
			  					<tr>
			                    <td height="35" align="right" bgcolor="#D4E5F4">租赁起止日期：</td>
			                    <td align="left" bgcolor="#FFFFFF">
			                    ...
			                    <td align="right" bgcolor="#D4E5F4">租用年限：</td>
			                    <td align="left" bgcolor="#FFFFFF"><c:out value='${entity.periods}'/></td>
			                </tr>
			                </c:if>
					        <tr>
					          <td height="35" align="right" bgcolor="#D4E5F4">墓穴价格：</td>
...
<!--           租用合葬时显示逝者和碑文信息 -->
          <c:if test='${entity.cemeteryRegistryType == 1 || entity.cemeteryRegistryType == 3}'>
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		       <tr>
		         <td>&nbsp;</td>
            </tr>
	        ...
	        <tr>
	          ...
	          <table width="100%" cellpadding="0" cellspacing="1"   bgcolor="#a6c6da">
	            ...
	            <tr>
	              ...
	              <td   align="center" bgcolor="#FFFFFF"><ft:dict value="${en.nativeplace}" /></td>
                 ...
                 <td height="102" bgcolor="#C4DEEE">
                  <table width="100%" cellpadding="0" cellspacing="1"    bgcolor="#a6c6da">
			       ...
			       <tr>
                      ...
                      <td width="13%" align="center" bgcolor="#FFFFFF"><c:out value="${cemeteryCharge.receivable}"/></td>
                	</tr>
                  </c:forEach>
                </table>
                 </td>
