  ...
  <tr>
    ...
    <td align="center" valign="top" >
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td height="31" align="left" valign="middle" style="background:url(../images/right-3.jpg)"><img src="../images/right-4.jpg" width="9" height="8" align="absmiddle" /> 当前位置 &gt; 档案管理 &gt; 逝者信息查看</td>
	      </tr>
	      <tr>
	      ...
	      <table width="98%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
	        ...
	        <tr>
	          ...
	          <td width="35%" align="left" bgcolor="#FFFFFF">${entity.idCardNum}</td>      
	        </tr>
			<tr>
