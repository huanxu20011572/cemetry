...
public class Base64 {
	...
	private static final byte[] encodingTable = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H',
	...
	private static final String charset_Unicode = "Unicode";
	...
	public static String decode(String data, String charset) throws Exception {
		if (data == null || data.length() == 0)
			return data;
		return new String(Base64.decodeToByte(data), charset);
	}
	...
	public static String decode(String data) throws Exception {
		return decode(data, charset_Unicode);
	}
	...
	public static String encode(String data) throws Exception {
		return encode(data, charset_Unicode);
	}

	public static void main(String[] args) throws Exception {
		String data1 = encode("cemeteryRegistryController.do?method=editCemeteryRegistry&id=150");
		String data2 = decode("//5jAGUAbQBlAHQAZQByAHkAUgBlAGcAaQBzAHQAcgB5AEMAbwBuAHQAcgBvAGwAbABlAHIALgBkAG8APwBtAGUAdABoAG8AZAA9AGUAZABpAHQAQwBlAG0AZQB0AGUAcgB5AFIAZQBnAGkAcwB0AHIAeQAmAGkAZAA9ADEANQAwAA==");
