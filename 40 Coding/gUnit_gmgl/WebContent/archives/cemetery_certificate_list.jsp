	...
	<table width="98%" border="0" cellspacing="0" cellpadding="10" class="word-4">
		<tr align="right" >
			...
			<ft:page action="cemeteryCertificateController.fj?method=getCemeteryCertificatePageList" page="${page}">
				...
				<input name="cemeteryLocationId" id="cemeteryLocationId" type="hidden" 
								value="<c:out value='${param.cemeteryLocationId}'/>" /> 
				<input name="cemeteryRegistryCode" type="hidden" id="cemeteryRegistryCode" class="input-1"  value="<c:out value='${param.cemeteryRegistryCode}'/>"/>
				<input name="name" type="hidden" id="name" class="input-1"  value="<c:out value='${param.name}'/>"/>
          		<input name="mobilePhone" type="hidden" id="mobilePhone" class="input-1"  value="<c:out value='${param.mobilePhone}'/>"/>
			</ft:page> 
			</td >
