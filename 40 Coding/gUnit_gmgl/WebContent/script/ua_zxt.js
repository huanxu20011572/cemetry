 ...
 * *** empty log message ***
 *
 * Revision 1.1  2005/11/29 13:56:36  sjz
 * *** empty log message ***
 *
...
function generateCheckBox1(parentfolderObject, itemLabel, checkBoxDOMId, linkLabel, isFld) {
    ...
    // they are the base of the simplest Treeview trees
        ...
        //itemLabel = itemLabel + "<a href='../user_mgm/userSelect.do?action=listByDept&id=" + checkBoxDOMId + "'>显示部门用户</a>" 
        itemLabel = itemLabel + "</td></tr></table></td>"; 
        if (isFld=="true"){	
