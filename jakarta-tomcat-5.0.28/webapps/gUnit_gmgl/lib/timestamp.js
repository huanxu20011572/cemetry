...
function show_timestamp(str_target, str_datetime) {
	...
	var str_buffer = new String (
		...
		"<tr>\n"+
		"<td bgcolor=\"#4682B4\"><a href=\"javascript:window.opener.show_timestamp('"+
		...
		"	<td bgcolor=\"#4682B4\" align=\"right\"><a href=\"javascript:window.opener.show_timestamp('"
	...
	str_buffer +=
		...
		"<font color=\"White\" face=\"tahoma, verdana\" size=\"2\">"+
		"时间: <input type=\"text\" name=\"time\" value=\""+dt2tmstr(dt_datetime)+
