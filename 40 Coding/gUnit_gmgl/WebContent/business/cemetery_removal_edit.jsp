...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
    <tr>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td height="31" align="left" valign="middle" 	style="background: url(../images/right-3.jpg)"><img src="../images/right-4.jpg" width="9" height="8" align="absmiddle" /> 当前位置 &gt; 业务办理 &gt; 迁出登记</td>
	    </tr>
	    <tr>
			            ...
			            <table id="baseInfo" width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
			                <tr>
			                    ...
			                    <tr  id="no_oneself3">
					              ...
					              <td height="35" colspan="3" align="left" bgcolor="#FFFFFF"><textarea name="agentReason" id="agentReason"  style='height: 40px; width: 90%'><c:out value='${entity.agentReason}'/></textarea></td>
			                    </tr>
					        <tr>
