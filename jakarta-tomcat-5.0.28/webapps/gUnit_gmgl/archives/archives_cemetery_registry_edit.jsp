			        ...
			        <tr>
			          ...
			          <td align="left" bgcolor="#FFFFFF">
			            ...
			            <input name="enddate" type="text" class="Wdate" id="enddate" onfocus="WdatePicker()" 
			            		value="<fmt:formatDate value='${entity.enddate}' pattern="yyyy-MM-dd" />" /></td>
      ...
      <tr>
        <td bgcolor="#C4DEEE"><table id="baseInfo" width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
            <tr>
              ...
              <td width="35%" align="left" bgcolor="#FFFFFF"><ft:radiosex name="sex" checked="${entity.sex}" /></td>
            </tr>
            <tr>
              <td height="35" align="right" bgcolor="#D4E5F4">民族：</td>
              <td align="left" bgcolor="#FFFFFF"><ft:select	name="nation" type="mz" selected="${entity.nation}"	style="width:190px"></ft:select></td>
