...
function doQuery(){
	...
	form.action = "../tree/doAddAdjust.do?method=list&adjustType=50161";
	form.submit();
}
function doMerger(){
...
<form name="queryForm" id="queryForm" action="" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
						...
						<td width="1191" background="../images/images_49.jpg">当前位置：区划管理->区划合并->查询</span> </td>
	 ...
	 <table width="99%" border="0" cellpadding="1" cellspacing="1" bgcolor="a8d1eb">
		...
		<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            		...
            		<input name="button" type="button" class="input_btn"  onClick="doMerger()" value="合并" align="left"/>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td align="center"    class="page">
        		<gOS:page name="page" pageName="page" action="../tree/doAddAdjust.do?method=list&adjustType=50161" pageSizeKey="list">
