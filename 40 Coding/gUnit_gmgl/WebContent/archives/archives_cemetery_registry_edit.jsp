...
<script type="text/javascript">
   ...
   function departedView(regeditId,id){
		var redirect_url =$.base64.encode('cemeteryRegistryController.fj?method=editCemeteryRegistry&cemeteryRegistryType=1&id='+regeditId);
	   	location.href="archivesDepartedController.fj?method=getDepartedViewById&id=" + id + "&regeditId=" + regeditId + "&redirect_url="+redirect_url;
   }
	//逝者信息增加 regeditId:业务id,id:逝者id
   ...
   function departedDel(regeditId,id){
	   var redirect_url =$.base64.encode('archivesCemeteryRegistryController.fj?method=editArchivesCemeteryRegistry&cemeteryRegistryType=1&id='+regeditId);
	   	location.href="archivesDepartedController.fj?method=deleteDepartedById&id=" + id + "&regeditId=" + regeditId + "&redirect_url="+redirect_url;
   }
      ...
      <tr>
        <td bgcolor="#C4DEEE"><table id="baseInfo" width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
            ...
            <tr>
              ...
              <td align="left" bgcolor="#FFFFFF"><ft:select	name="nation" type="mz" selected="${entity.nation}"	style="width:190px"></ft:select>
              <span class="word-7">*</span></td>
              <td height="35" align="right" bgcolor="#D4E5F4">国籍：</td>
              <td align="left" bgcolor="#FFFFFF"><ft:select	name="nationality" type="gj"	selected="${entity.nationality}" style="width:190px"></ft:select>
              <span class="word-7">*</span></td>
            </tr>
            <tr>
            ...
            <c:forEach var="en" items="${entity.archivesDeparteds}" varStatus="status">
              <tr>
                ...
                <td align="center" bgcolor="#FFFFFF" class="word-7"	width="20%">
          			...
          			<a	href="javascript:departedDel('${entity.id}','${en.id}');">删除</a>
          		</td>
              </tr>
            </c:forEach>
          </table></td>
        ...
        <td height="102" bgcolor="#C4DEEE"><table width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
            ...
            <c:forEach var="cemeteryCharge" items="${entity.archivesCemeteryCharges}" varStatus="status">
              <tr>
                ...
                <td align="center" bgcolor="#FFFFFF" class="word-7"	width="20%"><a href="archivesCemeteryRegistryController.fj?method=deleteCemeteryCharge&cemeteryRegistryType=${entity.cemeteryRegistryType}&id=${cemeteryCharge.id}&cemeteryRegistryId=${entity.id}">删除</a></td>
              </tr>
            </c:forEach>
          </table></td>
      </tr>
        ...
        <td bgcolor="#C4DEEE"><table width="100%" cellpadding="0" cellspacing="1" bgcolor="#a6c6da">
            ...
            <c:forEach var="cemeteryFile" items="${entity.archivesCemeteryFiles}" varStatus="status">
              <tr>
                ...
                <td align="center" bgcolor="#FFFFFF" class="word-7"	width="20%"><a	href="archivesCemeteryRegistryController.fj?method=deleteCemeteryFile&cemeteryRegistryType=<c:out value="${entity.cemeteryRegistryType}"/>&cemeteryRegistryId=<c:out value="${entity.id}"/>&id=<c:out value='${cemeteryFile.id}'/>">删除</a></td>
              </tr>
            </c:forEach>
          </table></td>
      </tr>
