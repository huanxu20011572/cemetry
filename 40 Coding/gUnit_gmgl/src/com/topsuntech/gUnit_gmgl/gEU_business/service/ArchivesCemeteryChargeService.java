...
public class ArchivesCemeteryChargeService extends HibernateBaseService {
	...
	public List<CemeteryCharge> getCemeteryChargeList(Page page, CemeteryCharge cemeteryCharge) {
		...
		if (StringUtils.isNotEmpty(cemeteryCharge.getProductType())) {
			querySql.append(" and bt.productType like ? ");
			objlist.add("%" + cemeteryCharge.getProductType() + "%");
			typelist.add(Hibernate.STRING);
		}
